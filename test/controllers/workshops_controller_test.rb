...
class WorkshopsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create workshop" do
    assert_difference('Workshop.count') do
      post workshops_url, params: { workshop: { finish_time: @workshop.finish_time, start_time: @workshop.start_time } }
    end
  ...
  test "should update workshop" do
    patch workshop_url(@workshop), params: { workshop: { finish_time: @workshop.finish_time, start_time: @workshop.start_time } }
